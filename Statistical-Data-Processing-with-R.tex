...
\cfoot[\em Издателство \say{Образование и Познание}, 2019]{\em Издателство \say{Образование и Познание}, 2019} 
...
\includepdf[pages={1}]{images/front}
\thispagestyle{empty}
...
~\vfill
\thispagestyle{empty}
\noindent Авторски права \copyright\ 2019 \\
...
\noindent \textit{Първо издание, 2019}
...
\bibitem{r08} Matloff, N.: The Art of R Programming: A Tour of Statistical Software Design 1st Edition, No Starch Press, 2011.

\bibitem{r09} Gardener, M.: Beginning R The Statistical Programming Language 1st Edition, Wrox, 2012.

\bibitem{r10} Chambers, J.: Software for Data Analysis: Programming with R (Statistics and Computing) 2nd Edition, Springer, 2009.

\bibitem{r01} Venables, W., Smith D.: An Introduction to R Notes on R: A Programming Environment for Data Analysis and Graphics, \\\texttt{https://cran.r-project.org/doc/manuals/r-release/R-intro.pdf}

\bibitem{r02} R Data Import/Export, \\\texttt{https://cran.r-project.org/doc/manuals/r-release/R-data.pdf}

\bibitem{r03} R Installation and Administration, \\\texttt{https://cran.r-project.org/doc/manuals/r-release/R-admin.pdf}

\bibitem{r04} Writing R Extensions, \\\texttt{https://cran.r-project.org/doc/manuals/r-release/R-exts.pdf}

\bibitem{r05} R Language Definition, \\\texttt{https://cran.r-project.org/doc/manuals/r-release/R-lang.pdf}

\bibitem{r06} R Internals, \\\texttt{https://cran.r-project.org/doc/manuals/r-release/R-ints.pdf}

\bibitem{r07} R A Language and Environment for Statistical Computing, \\\texttt{https://cran.r-project.org/doc/manuals/r-release/fullrefman.pdf}
